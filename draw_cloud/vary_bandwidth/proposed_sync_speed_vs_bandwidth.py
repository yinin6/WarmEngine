...
def draw_both():
    ...
    # 设置 data1 的 y 轴
    ax1.set_ylabel('Reconfig. lifecycle - Proposed',fontsize=23)
    ax1.set_ylim(0, 4)  # 根据实际数据调整y轴范围

    ax1.set_xticklabels(['500000', '1000000'],fontsize=20)
    # ax1.set_xlabel('Bandwidth (Mbps)',fontsize=20)
    ...
    t1=data1_means[0]/ data1_means[1]
    print(t1)
    # 添加均值差的竖线
    ...
    ax1.text(0.8, (data1_means[0] + data1_means[1]) / 2 , f'{t1:.2f}×',
             color="purple", ha='center', fontsize=25)

    print(data2_means[0] / data2_means[1])

    t2 = data2_means[0] / data2_means[1]
    ...
    ax2.text(2.6, (data2_means[0] + data2_means[1]) / 2, f'{t2:.2f}×',
             color="purple", ha='center', fontsize=25)

    ax2.set_ylabel('Reconfig. lifecycle - tMPT',fontsize=23)
    ax2.tick_params(axis='y', labelsize=25)
    ax1.tick_params(axis='y', labelsize=25)
    ax1.tick_params(axis='x', labelsize=25)
    ax2.set_ylim(0, 80)  # 根据实际数据调整y轴范围
    ax2.set_xticks([1.2, 2.2],['4 Mbps', '8 Mbps'],fontsize=22)
    # 添加图例
    ax1.legend([box1["boxes"][0], box2["boxes"][0]], ['Proposed', 'tMPT'],fontsize=25)
