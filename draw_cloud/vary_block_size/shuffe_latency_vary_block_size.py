...
ax.set_xlabel('Num. of TXs in each block', fontsize=20)
ax.set_ylabel('Reconfiguration Latency (Sec.)', fontsize=20)
...
plt.tight_layout()
plt.savefig(f'../pics/shuffe_latency_vary_injectSpeed.pdf')
plt.show()
