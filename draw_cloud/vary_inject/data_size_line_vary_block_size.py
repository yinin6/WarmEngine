...
block_sizes = [ 1000, 2000,3000,4000 ,5000]
...
ax.set_xlabel('Injection rate (TXs/Sec.)', fontsize=font_size)
ax.set_ylabel('Reconfig. data size (Bytes)', fontsize=font_size)
...
plt.tight_layout()
plt.savefig(f'../pics/shuffe_datasize_vary_inject.pdf')
plt.show()
